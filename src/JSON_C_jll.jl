...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import JSON_C_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("9cdfc4e7-e793-5089-b6f7-569a57a60f0a"))
platforms = [Pkg.Artifacts.unpack_platform(e, "JSON_C", artifacts_toml) for e in artifacts["JSON_C"]]
...
if best_platform === nothing
    @debug("Unable to load JSON_C; unsupported platform $(triplet(platform_key_abi()))")
else
